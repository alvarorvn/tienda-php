      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php">
            <!--<img class="img-responsive logo img-thumbnail" src="../img/ventas.jpg" alt="" width="150px" height="150px">--></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">

          <img class="img-responsive img-thumbnail" src="../img/ventas.jpg" alt="" width="80px" height="40px">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-list-alt"></span> Gestión Articulos <span class="caret"></span></a>
